...
import furhatos.app.fortuneteller.TarotFortuneSkill
import furhatos.app.fortuneteller.flow.fortune.Start
import furhatos.app.fortuneteller.flow.main.Idle
import furhatos.app.fortuneteller.flow.paralell.InteractionGlow
import furhatos.app.fortuneteller.setting.*
import furhatos.app.fortuneteller.utils.loadProperties
...
val log = CommonUtils.getLogger(TarotFortuneSkill::class.java)
